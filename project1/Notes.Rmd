...
As we can see, the standard function is 10 times faster than kmeans++. For some applications, this disqualifies the method. There are however possible workarounds. One thing is alogirthm complexity itself, and the other is implementation - to make kmeans++ code faster, implementing it in C or Fortran (as basic *stats::kmeans* code) would be needed.
